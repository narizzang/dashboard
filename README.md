...
Click [here](https://mybinder.org/v2/gh/narizzang/dashboard/HEAD?urlpath=voila%2Frender%2FDashboard.ipynb) to render the dashboard template (```Dasboard.ipynb```) with Voila; this is where you will assemble your dashboard after going through the other notebooks.
